...
nico = User.create!(name: "Nico", phone_number: '255484125', email: 'nico@hotmail.com', password: '123456')
max = User.create!(name: "Max", phone_number: '27748445', email: 'max@hotmail.com', password: '123456')
thomas = User.create!(name: "Thomas", phone_number: '25555445', email: 'thomas@hotmail.com', password: '123456')
